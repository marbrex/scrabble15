...
//
//                pane.setOnMouseEntered(event -> pane.setStyle("-fx-background-color: CRIMSON"));
//
//                pane.setEffect(is);
//
//                GridPane.setConstraints(pane, i, j);
//                gridPaneUI.getChildren().add(pane);
            }
        }
...
//            });
            ...
            ltr.setOnMouseDragged(event -> {
                ...
                ltr.setLayoutX(event.getX() + ltr.getLayoutX() - ltr.getWidth()/2);
                ltr.setLayoutY(event.getY() + ltr.getLayoutY() - ltr.getHeight()/2);
//                System.out.println("Layout: (" + ltr.getLayoutX() + ", " + ltr.getLayoutY() + ")");
